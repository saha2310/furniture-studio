    ...
    <footer className={`border-t border-white/10 bg-[#171716] ${className}`}>
      ...
      <div className="relative overflow-hidden">
        ...
        <svg
          aria-hidden="true"
          viewBox="0 0 800 600"
          className="pointer-events-none absolute -right-8 bottom-0 z-0 hidden w-[360px] translate-y-6 text-white/20 lg:block xl:w-[440px]"
        >
          <g fill="none" stroke="currentColor" strokeWidth="1">
            ...
            <path d="M92 158h260" />
            {/* Размер */}
            <text x="210" y="10" textAnchor="middle" className="fill-white/25 text-[9px]">
              3200
            </text>
          </g>
        </svg>
