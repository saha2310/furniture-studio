    ...
    <section className="border-b border-ink/10 bg-surface">
      <div className="container-studio grid gap-12 py-24 lg:grid-cols-[.8fr,1fr] lg:gap-24 lg:py-28">
        ...
        <div className="flex flex-col justify-end">
          ...
          <p className="mt-10 max-w-[42ch] text-[13px] leading-6 text-stone">Каждое изделие собирается вручную под ваш заказ и проходит контроль перед передачей клиенту.</p>
        </div>
      </div>
    </section>
  );
