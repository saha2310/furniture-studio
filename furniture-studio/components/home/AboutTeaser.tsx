      ...
      <div className="container-studio grid gap-12 py-24 lg:grid-cols-[.8fr,1.2fr] lg:gap-24 lg:py-28">
        ...
        <div className="flex flex-col justify-end">
          ...
          <div className="mt-12 flex items-end justify-between border-t border-white/10 pt-6">
            ...
            <Link href="/about" className="group about-teaser-button text-[11px] uppercase tracking-[0.14em] text-espresso hover:text-white">Подробнее о мастерской <span className="ml-4 inline-block transition-transform duration-300 group-hover:translate-x-1">→</span></Link>
          </div>
        </div>
      </div>
    </section>
