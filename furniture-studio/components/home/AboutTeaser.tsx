    ...
    <section className="border-b border-ink/10 bg-canvas">
      <div className="container-studio grid gap-12 py-24 lg:grid-cols-[.8fr,1.2fr] lg:gap-24 lg:py-28">
        ...
        <div className="flex flex-col justify-end">
          ...
          <div className="mt-12 flex items-end justify-between border-t border-ink/10 pt-6">
            <div><span className="text-5xl tracking-[-0.05em]">18</span><span className="ml-2 text-xs text-stone">мес. гарантии</span></div>
            <Link href="/about" className="group about-teaser-button text-[11px] uppercase tracking-[0.14em] text-espresso hover:text-ink">Подробнее о мастерской</Link>
          </div>
        </div>
      </div>
    </section>
