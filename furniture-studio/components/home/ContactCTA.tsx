...
export function ContactCTA({ title }: { title?: string | null } = {}) {
  ...
  return (
    <section ref={sectionRef} className="border-b border-white/10 bg-[#1c1b19]">
      <div className="container-studio grid lg:min-h-[560px] lg:grid-cols-2 lg:items-stretch lg:gap-10 lg:py-0">
        ...
        >
          <div
            className="absolute inset-y-0 left-0 w-[50vw] max-w-none overflow-hidden rounded-l-[20px]"
            style={{
