      ...
      <div className="container-studio relative z-10 flex min-h-[780px] flex-col justify-between pb-9 pt-36 sm:min-h-[820px] lg:min-h-screen lg:pb-12 lg:pt-40">
        <div className="max-w-[780px]">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href={data.primaryCtaHref} className="reference-button border-white/30">
              {data.primaryCtaLabel} <span aria-hidden>→</span>
            </Link>
            <Link href={data.secondaryCtaHref} className="reference-button border-white/15 text-white/80 hover:border-white hover:bg-transparent hover:text-white">
              {data.secondaryCtaLabel} <span aria-hidden>↗</span>
            </Link>
          </div>
        </div>
