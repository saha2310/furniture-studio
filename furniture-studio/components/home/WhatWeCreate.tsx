        ...
        <div className="grid border-t border-ink/20 sm:grid-cols-2">
          {categories.map((category, index) => (
            <Link
              ...
              className="group relative isolate flex min-h-[250px] overflow-hidden flex-col justify-between border-b border-ink/20 p-6 transition-colors hover:bg-ink/[0.03] sm:border-r sm:p-8 lg:min-h-[300px]"
            >
              {category.image_path && (
                <Image
