  ...
  return (
    <div>
      <div className="group relative min-w-0 overflow-hidden bg-surface">
        ...
        {images.length > 1 && (
          <div className="gallery-pill liquid-glass-on-image absolute bottom-4 left-1/2 z-10 -translate-x-1/2 sm:bottom-5">
            <button type="button" aria-label="Предыдущее изображение" onClick={prev} className="gallery-pill-arrow">
            ...
            <span className="gallery-pill-count tabular-nums">
              {String(activeIndex + 1).padStart(2, '0')} / {String(images.length).padStart(2, '0')}
            </span>
            <button type="button" aria-label="Следующее изображение" onClick={next} className="gallery-pill-arrow">
              <svg width="15" height="15" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
