      ...
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-8 flex items-end justify-between gap-5">
          <div>
            ...
            {work.price && <p className="mt-2 text-[12px] text-ink">{work.price}</p>}
            {work.description && <p className="mt-3 line-clamp-2 max-w-[30ch] text-[12px] leading-5 text-espresso">{work.description}</p>}
            {work.description && work.description.length > 110 && <span className="mt-2 inline-block text-[10px] uppercase tracking-[.12em] text-ink">Читать далее →</span>}
          </div>
