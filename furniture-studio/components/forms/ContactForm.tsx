...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="group liquid-glass-button liquid-glass-on-dark inline-flex w-full items-center justify-between px-5 py-4 text-[11px] uppercase tracking-[0.14em] text-ink/80 disabled:opacity-60"
    >
