...
function Submit({ label }: { label: string }) {
  ...
  return <button type="submit" disabled={pending} className="border border-ink/20 bg-ink px-4 py-3 text-[10px] uppercase tracking-[0.12em] text-black disabled:opacity-50">{pending ? 'Сохраняем…' : label}</button>;
}
