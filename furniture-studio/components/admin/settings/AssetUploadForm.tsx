...
export function AssetUploadForm({ field, label, currentPath, help }: {
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4 border border-white/10 bg-[#171716] p-4">
      ...
      <div className="flex items-center gap-3 border-t border-white/10 pt-4">
        <button type="submit" className="bg-white px-4 py-3 text-[10px] uppercase tracking-[0.12em] text-black">Сохранить изображение</button>
