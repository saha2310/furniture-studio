    ...
    <div className="space-y-8">
      ...
      <div className="border-t border-white/10 pt-6">
        ...
        <input
          ...
          className="mt-4 block text-sm text-espresso file:mr-4 file:rounded file:border-0 file:bg-white/10 file:px-4 file:py-2 file:text-sm file:text-white file:hover:bg-white/15"
        />
