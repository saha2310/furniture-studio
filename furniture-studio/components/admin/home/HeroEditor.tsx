...
function SubmitButton() { const { pending } = useFormStatus(); return <button type="submit" disabled={pending} className="bg-ink px-6 py-3 text-[10px] uppercase tracking-[0.12em] text-black disabled:opacity-50">{pending ? 'Сохраняем…' : 'Сохранить первый экран'}</button>; }
