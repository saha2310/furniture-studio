...
function RowActions({ request }: { request: ContactRequest }) {
  return <div className="flex items-center justify-end gap-2">
    <Link href={`/admin/contacts/${request.id}`} className="inline-flex min-h-9 items-center rounded-full border border-ink/15 bg-ink/[0.035] px-3 text-[10px] font-medium uppercase tracking-[0.12em] text-ink/75 transition-colors hover:border-ink/30 hover:bg-ink/[0.07] hover:text-ink">Открыть</Link>
