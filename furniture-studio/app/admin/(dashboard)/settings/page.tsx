import { getSiteSettings, getAllContactLinksAdmin } from '@/lib/queries/site';
...
export default async function AdminSettingsPage() {
  const [settings, contactLinks] = await Promise.all([getSiteSettings(), getAllContactLinksAdmin()]);
