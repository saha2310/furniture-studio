...
export default async function AdminSettingsPage() {
  ...
  return <div className="max-w-5xl"><PageHeader title="Настройки" description="Общие данные, SEO, изображения бренда, меню и способы связи." /><div className="mt-6 space-y-3">
    <AdminSection title="Основное и SEO" description="Название, контакты и значения SEO по умолчанию." defaultOpen><GeneralSettingsForm settings={settings} phones={contactLinks.filter((l) => l.platform === 'phone')} /></AdminSection>
    ...
    <AdminSection title="Способы связи" description="Telegram, WhatsApp, VK и другие контакты, которые показываются на сайте. Телефоны — в разделе «Основное»."><SocialLinksManager links={contactLinks.filter((l) => l.platform !== 'phone')} /></AdminSection>
